...
Should just work with platformio, but if you're on windows then you need to copy the repo with symlinks (https://github.com/usaatyuk/EggbotWireless/issues/2#issuecomment-570766029)
