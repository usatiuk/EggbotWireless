...
U 1 1 5B8ADE59
P 10150 800
F 0 "U3" H 10150 915 50  0000 C CNN
F 1 "DW01" H 10150 824 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23-6_Handsoldering" H 10100 1000 50  0001 C CNN
...
U 1 1 5B8B0568
P 10600 1600
F 0 "U4" H 10600 1715 50  0000 C CNN
F 1 "FS8205A" H 10600 1624 50  0000 C CNN
F 2 "Package_SO:TSSOP-8_4.4x3mm_P0.65mm" H 10490 1715 50  0001 C CNN
F 3 "" H 10490 1715 50  0001 C CNN
	1    10600 1600
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5B8B09A7
P 8600 1050
F 0 "J1" H 8494 725 50  0000 C CNN
F 1 "BATT" H 8494 816 50  0000 C CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_1x02_P2.54mm_Vertical" H 8600 1050 50  0001 C CNN
...
U 1 1 5B8B0C86
P 9400 950
F 0 "R2" V 9193 950 50  0000 C CNN
F 1 "100" V 9284 950 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 9330 950 50  0001 C CNN
...
U 1 1 5B8B0F0A
P 9600 1250
F 0 "C4" H 9800 1200 50  0000 R CNN
F 1 "100nf" H 9950 1300 50  0000 R CNN
...
Wire Wire Line
	11200 1350 11200 1900
Wire Wire Line
	11200 1900 10950 1900
Wire Wire Line
	9600 1850 9600 1500
Wire Wire Line
	9250 800  9250 950 
...
U 1 1 5B8B26F4
P 10750 1050
F 0 "R3" V 10543 1050 50  0000 C CNN
F 1 "1K" V 10634 1050 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 10680 1050 50  0001 C CNN
...
F 1 "+BATT" H 9265 973 50  0000 C CNN
...
U 1 1 5CEB412D
P 11050 1800
F 0 "#PWR0114" H 11050 1550 50  0001 C CNN
...
F 1 "Stepper_Motor_bipolar" H 6188 3983 50  0000 L CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_1x04_P2.54mm_Vertical" H 6010 3940 50  0001 C CNN
...
F 1 "Stepper_Motor_bipolar" H 6138 5833 50  0000 L CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_1x04_P2.54mm_Vertical" H 5960 5790 50  0001 C CNN
...
U 1 1 5CF86B51
P 4600 6100
F 0 "#PWR0146" H 4600 5950 50  0001 C CNN
F 1 "+3.3V" H 4615 6273 50  0000 C CNN
...
U 1 1 5CEA7A5C
P 3450 3750
F 0 "M3" H 3782 3815 50  0000 L CNN
F 1 "Motor_Servo" H 3782 3724 50  0000 L CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_1x03_P2.54mm_Vertical" H 3450 3560 50  0001 C CNN
F 3 "http://forums.parallax.com/uploads/attachments/46831/74481.png" H 3450 3560 50  0001 C CNN
	1    3450 3750
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5CEB75C4
P 3150 3850
F 0 "#PWR0150" H 3150 3600 50  0001 C CNN
...
U 1 1 5CED285F
P 3150 3750
F 0 "#PWR0151" H 3150 3600 50  0001 C CNN
F 1 "+3.3V" H 3100 3900 50  0000 C CNN
...
U 1 1 5CEB7C0D
P 9000 950
F 0 "SW1" H 9000 1235 50  0000 C CNN
F 1 "SW_SPDT" H 9000 1144 50  0000 C CNN
F 2 "Button_Switch_THT:SW_CuK_OS102011MA1QN1_SPDT_Angled" H 9000 950 50  0001 C CNN
